...
--     hash is keyed on that tick. Filed as NR-590.
...
--     which is true of hover and is not true of the LOG. Filed as NR-591.
--
...
-- And the hash does NOT, which is the symptom NR-590 names. Asserted in the
...
verify.expect(verify.state_hash() ~= live_hash,
              "state_hash moves across the round trip (NR-590): "
