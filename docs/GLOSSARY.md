...
**Two adjacent senses of "company" predate this and are unaffected**, because neither names a background firm: the design test's "company" (`docs/CONCEPT.md` § Player identity), which means the player's corporation, and the "private companies who can quote" of the procurement seam — the latter now reads as the general commercial population, which is what this entry makes precise. Where ambiguity would bite, say *background firm*.
...
**Mercenary company**
**Retired** (Ben, 2026-09-17, NR-885). It was the player's identity from 2026-08-12 (NR-177): armed professionals for hire, paid for outcomes under mercenary contracts, which went on 2026-08-30 (`docs/military/MILITARY.md`). The player is a **Corporation** that holds a seat; do not design against this word. See `docs/CONCEPT.md` § Player identity.
