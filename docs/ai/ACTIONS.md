...
*121 entries — 15 gameplay · 24 canvas · 15 lens · 38 ledger · 29 chrome.*
...
| `subject` | `entity_id` | The body the contract would fulfil at. Note the seam resolves the actual body from the SUPPLIER's capacity, so this is context rather than a constraint. |
