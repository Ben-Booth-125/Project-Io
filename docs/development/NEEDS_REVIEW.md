...
*15 entries — 4 open, 11 resolved.*

---

## Open

### NR-908 — wide8 is now the live F9 tech-tree treatment, while GLOBAL_STYLE_SHEET still calls it unsettled
...
### NR-909 — Tech-node component glyphs kept local to tech_tree_panel.cpp rather than promoted into icons.hpp / ICONS.md
...
### NR-910 — Four of 150 techs have an authored gate, so the F9 viewer's settled palette cannot render without a fictional preview
...
### NR-911 — On-canvas node labels overlap badly at real Era-1 density
