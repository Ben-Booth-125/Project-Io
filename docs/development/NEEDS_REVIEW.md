...
*244 entries — 244 open, 0 resolved.*
...
### NR-577 — A ruling was taken on a stale doc paragraph — the four "dominated" recipe pairs are false positives, and the real finding is the opposite
...
### NR-578 — Sprint 17 authored: ten items, six rulings, and four calls taken inside them
