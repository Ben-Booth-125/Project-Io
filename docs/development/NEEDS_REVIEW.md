...
### NR-742 — wide8 is now the live F9 tech-tree treatment, while GLOBAL_STYLE_SHEET still calls it unsettled
...
### NR-743 — Tech-node component glyphs kept local to tech_tree_panel.cpp rather than promoted into icons.hpp / ICONS.md
...
### NR-744 — Four of 150 techs have an authored gate, so the F9 viewer's settled palette cannot render without a fictional preview
...
### NR-745 — On-canvas node labels overlap badly at real Era-1 density
