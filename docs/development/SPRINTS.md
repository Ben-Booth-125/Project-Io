...
| 37 | how humanity spreads before it fights | CLOSED 2026-09-09. Design pass and build in one day. The migration span exists, runs inside the recorded history, and has its own wizard round: the world now OPENS as a handful of cradles and fills on camera, where it used to open already full. 14 items delivered (BL-829/830/846/847/848/850/851/856/857/858/860/862/863/864, on top of BL-817). The wizard walks five named rounds -- System, Life, Culture, Empires, Industrialisation. |
