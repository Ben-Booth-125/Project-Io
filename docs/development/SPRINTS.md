...
| 31 | Long-term market viability - every recipe pays at base price | OPEN. 2026-09-02: the debt instrument (campaign_lapse, every corp's balance delta attributed by tick phase, debt.csv per entry) found the industrial collapse: an unmet goods-upkeep draw decays every building to zero at exactly tick 20 (BL-746, priority A, NR-782 for the rule). With the draws zeroed the field is solvent and growing. Construction materials at ceiling prices are the first debt wave (BL-745, re-scoped to B). |
