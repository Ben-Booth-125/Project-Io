...
**Next up.** SPRINT NUMBERING: reset by Ben on 2026-08-30 (the next new sprint was 26); sprints 26-31 have run and are cold. Ben named the growth half of sprint 31 SPRINT 33 on 2026-09-02, so 32 is unused by his call, not by accident. THE NEXT NEW SPRINT IS 34.
...
*45 sprints archived cold; 1 open/gated in the hot store.*
