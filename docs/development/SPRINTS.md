...
| 32 | Logistic Points, and the map that shows them through both fogs | **Gated 2026-08-23** — third sprint under the cap; BL-595/596/597 designed, **paused pending NR-578** — no promotion until Ben rules |
...
**Sprint 32's sequencing is flagged, not assumed (NR-578).** ROADMAP.md names Logistic Points for
...
**PAUSED 2026-08-23, pending NR-578.** BL-595/596/597 are designed but not promoted — do not move
any of them into REFINED.md or start build until Ben rules on NR-578's sequencing question. This
