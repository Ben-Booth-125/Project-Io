...
| 31 | Long-term market viability - every recipe pays at base price | OPENED 2026-09-02 on Ben's call - "another refinement on long-term market viability". The instrument (BL-744, recipe_margin) was built the same day and its first run IS the opening finding: 41 of 44 priced recipes fail the marginal anchor, 16 of 18 extraction targets fail the floor anchor, in both bands. |
