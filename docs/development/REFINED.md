...
- [x] C4 BL-1085 (Begin retired into round six): a per-tick progress tap on the settle so the
  ...
  bar still holds for that one lap. ACCEPTED at lap grain (Ben, 2026-09-25): the stop is a real
  cost and BL-1117 (settle tick one cost) removes it; no tap is threaded into `run_economy_step`.
