...
- [ ] **BL-1056 (points size-neutral)** — MERGED acc81398; the cold review found the treasury split breaks reading 8's scale/treasury split and a fallback that grows with size; fix round in its lane 2026-09-19. Ben 2026-09-19 (NR-896, NR-897, both option A): the Fuel Doctrine pulls read the share of held regions over the world mean; treasury points spread over centres by urban scale. Behind the switch. files: history_sim.*, digitisation_sim_harness.cpp, exploration_sim_harness.cpp.
