...
- [ ] **BL-1059 (top-third bar)** — Ben 2026-09-19 (NR-899, option C): each Fuel Doctrine pull counts held regions in its own resource's top third, a bar fixed at the span open. Behind the switch. files: history_sim.*, digitisation_sim_harness.cpp, exploration_sim_harness.cpp.
- [ ] **BL-1042 (stockpile to budget)** — waits on BL-1039 and BL-1059. files: population_generation.*, world.hpp, hard_coded_world.cpp, landscape_search.hpp, src/core/app.cpp, harness_params.hpp, verify_api.cpp, main.cpp, player_seed_sweep.cpp, world_determinism.cpp.
