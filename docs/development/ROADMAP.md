...
| **Who owns whom** | Ownership separates from identity: a corporation has one owner and changes hands **whole**, by buyout, priced from its own filed returns. Which firms are legible and buyable is generated, not authored. |
