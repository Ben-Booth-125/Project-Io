...
| Hover tooltip | Tile coordinates `[col, row]`, terrain name, hazard, habitability, and all four resource deposit values (suppress zero deposits), plus a road-tier line (BL-184) when the tile carries one. |
