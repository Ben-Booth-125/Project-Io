...
| **Unit** | *(no glyph)* | Units are selectable on the Planetary canvas (hit-tested after building and market centre) but draw **no marker**; the unit marker and its command surface are BL-471 (unit marker and command surface) | — | — |
