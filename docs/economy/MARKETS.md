...
4. **Standing sell orders** — read from `world::sell_orders`, quantity capped by the pool,
   entered into both market supply and the explicit sell book with their `floor_price`.
