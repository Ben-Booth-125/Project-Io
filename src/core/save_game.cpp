...
void w_timelapse(std::ostream& o, const era_timelapse& t)
{
    ...
    // in step. One string per polity id, AFTER the BL-1106 tables above.
...
bool r_timelapse(std::istream& i, era_timelapse& t)
{
    ...
    if (!r_vec(i, t.polity_creed, [](std::istream& s, int32_t& v) {
        ...
        return false;
    // save_game_version 22 (BL-1088) -- keep w_timelapse in step: the realm
    // name table comes AFTER the three BL-1106 tables above.
