...
The canonical resource list: **37** resources organised into three tiers (raw → refined → product) — their terrain affinity and body availability, the Era 0 / Era 1 split, and the seven-resource prototype subset. (Was 42 until 2026-08-16, when NR-257 removed five of BL-286's logistics goods that had sat produced-by-nothing and consumed-by-nothing since they were added.) Read before any work involving resource types, tile deposits, or market goods.
