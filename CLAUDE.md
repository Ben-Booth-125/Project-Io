...
| `docs/generation/INDUSTRIALISATION.md` | **1660 → 1960 — a PLACEHOLDER.** Owns only the boundary: which subjects are Industrialisation's (companies, prices, tariffs) rather than Exploration's. |
